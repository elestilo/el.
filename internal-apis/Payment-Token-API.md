...
- [Tutorials](#tutorials)
  - [Adding Payment Token API Support To Your Gateway](#adding-payment-token-api-support-to-your-gateway)
    - [Step 0: Extending The Correct Gateway Base](#step-0-extending-the-correct-gateway-base)
    - [Step 1: 'Supports' Array](#step-1-supports-array)
    - [Step 2: Define A Method For Adding/Saving New Payment Methods From "My Account"](#step-2-define-a-method-for-addingsaving-new-payment-methods-from-my-account)
    - [Step 3: Save Methods On Checkout](#step-3-save-methods-on-checkout)
    - [Step 4: Retrieve The Token When Processing Payments](#step-4-retrieve-the-token-when-processing-payments)
  - [Creating A New Token Type](#creating-a-new-token-type)
    - [Step 0: Extend WC_Payment_Token And Name Your Type](#step-0-extend-wc_payment_token-and-name-your-type)
    - [Step 1: Provide A Validate Method](#step-1-provide-a-validate-method)
    - [Step 2: Provide get\_ And set\_ Methods For Extra Data](#step-2-provide-get%5C_-and-set%5C_-methods-for-extra-data)
    - [Step 3: Use Your New Token Type](#step-3-use-your-new-token-type)
- [Classes](#classes)
  - [WC_Payment_Tokens](#wc_payment_tokens)
    - [get_customer_tokens( $customer_id, $gateway_id = '' )](#get_customer_tokens-customer_id-gateway_id---)
    - [get_customer_default_token( $customer_id )](#get_customer_default_token-customer_id-)
    - [get_order_tokens( $order_id )](#get_order_tokens-order_id-)
    - [get( $token_id )](#get-token_id-)
    - [delete( $token_id )](#delete-token_id-)
    - [set_users_default( $user_id, $token_id )](#set_users_default-user_id-token_id-)
    - [get_token_type_by_id( $token_id )](#get_token_type_by_id-token_id-)
  - [WC_Payment_Token_CC](#wc_payment_token_cc)
    - [validate()](#validate)
    - [get_card_type()](#get_card_type)
    - [set_card_type( $type )](#set_card_type-type-)
    - [get_expiry_year()](#get_expiry_year)
    - [set_expiry_year( $year )](#set_expiry_year-year-)
    - [get_expiry_month()](#get_expiry_month)
    - [set_expiry_month( $month )](#set_expiry_month-month-)
    - [get_last4()](#get_last4)
    - [set_last4( $last4 )](#set_last4-last4-)
  - [WC_Payment_Token_eCheck](#wc_payment_token_echeck)
    - [validate()](#validate-1)
    - [get_last4()](#get_last4-1)
    - [set_last4( $last4 )](#set_last4-last4--1)
  - [WC_Payment_Token](#wc_payment_token)
    ...
    - [get_gateway_id](#get_gateway_id)
    - [set_gateway_id( $gateway_id )](#set_gateway_id-gateway_id-)
    - [is_default()](#is_default)
    - [set_default( $is_default )](#set_default-is_default-)
    - [validate()](#validate-2)
    - [read( $token_id )](#read-token_id-)
    - [update()](#update)
    - [create()](#create)
    - [save()](#save)
    - [delete()](#delete)
