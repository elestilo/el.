...
`order_type` | `string` | Order type. Valid values: `shop_order`, `refund` | `shop_order`
`order_key` | `string` | Random hash/order key | `xxxxxxxx`
`order_currency` | `string` | Currency the order was created with | `GBP`
...
`order_total ` | `string` | Grand total. Ran through `wc_format_decimal`. | `20.00`
`order_tax ` | `string` | Sum of ALL taxes. Ran through `wc_format_decimal`. | `20.00`
